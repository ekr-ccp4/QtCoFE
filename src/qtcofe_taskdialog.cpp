...
//  ----------------------------------------------------------------
//
//  **** Module  :  qtcofe_taskdialog <implementation>
//       ~~~~~~~~~
...
//          btn->setStyleSheet ( btn->styleSheet() + btnStyle   );
  ...
  lbl->setStyleSheet (
    QString("font-weight: bold; font-style: italic; font-size: %1pt;")
                           .arg(6*preferences->getFontPointSize()/5) );
